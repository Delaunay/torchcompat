#!/usr/bin/env python
"""
torchcompat documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "torchcompat"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import torchcompat.core  # noqa
...
project = "torchcompat"
_full_version = torchcompat.core.__version__
author = torchcompat.core.__author__
copyright = torchcompat.core.__copyright__
...
htmlhelp_basename = "torchcompat-doc"
